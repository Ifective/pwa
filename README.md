...
- Gebruik het cd command om naar het angular project te navigeren
...
Deze melding “serviceWorkers toegoegen aan startscherm” word default getoont. Dit omdat er word voldaan aan de criteria welke aan een pwa binnen Chrome worden gesteld. Het probleem is alleen dat wanneer de gebruiker besluit deze melding weg te klikken de vraag of de gebruiker de app wil toevoegen aan het startscherm pas 3 maanden later opnieuw word gesteld.
